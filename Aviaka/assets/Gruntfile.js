		...
		uglify: {
			dist: {
				files: {
					...
					'../markup/js/jquery.mousewheel.min.js': ['dist/js/plugin/jquery.mousewheel.js'],
					'../markup/js/jquery.mask.min.js': ['dist/js/plugin/jquery.mask.js'],
					'../markup/js/jQueryUITouchPunch.min.js': ['dist/js/plugin/jQueryUITouchPunch.js'],
					'../markup/js/jquery.scrollify.min.js': ['dist/js/plugin/jquery.scrollify.js'],
